...
plt.bar(index, tf_values, bar_width, color='blue')
plt.bar(index + 1* bar_width, ds_values, bar_width, color='green')
plt.bar(index + 2 * bar_width, ff_values, bar_width, label='FastFlow', color='orange')
...
plt.title('(b) GAN ADA',fontsize=fontsize, pad=20)

fig.set_size_inches(8, 6)
fig.set_dpi(100)
plt.legend(fontsize=fontsize, ncol=3, columnspacing=1, markerfirst=False, handletextpad=0.5)
plt.savefig('ff-gan.eps',  bbox_inches='tight')
